            ...
            <div className=" mx-auto flex justify-between ss:flex-row flex-col xs:items-center gap-5 p-5  ">
                ...
                <form className="ss:w-[300px] w-full xs:w-[70%] " onSubmit={submitHandler}>
                    ...
                    <input
                        ...
                        value={value.phone}
                    />
                    <button type='submit' href="#" className=' uppercase inline-block text-base bg-primary hover:bg-white hover:text-primary border border-primary duration-500 rounded-full py-6 px-12  w-full font-bold text-white ' disabled={isLoading} >{isLoading ? 'jonatilmoqda...' : 'savol berish'}</button>
