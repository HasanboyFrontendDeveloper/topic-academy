        ...
        <div className='py-5 mb-20 '>
            ...
            <div className="flex gap-16 w-[95%] mx-auto sm:w-[90%] sm:ml-auto sm:mr-0 ">
                <div className="">
                    ...
                    <a href="#contacts" className=' uppercase inline-block text-base ss:text-xl bg-primary hover:bg-white hover:text-primary border border-primary duration-500 rounded-full py-4 px-12 max-w-[90%] w-80 ss:max-w-max ss:w-auto font-bold text-white ' >Ariza Qoldirish</a>
                </div>
